...
if [ $run_mode = 1 ]; then
	matlab -nodesktop -nodisplay -nosplash -r $MAT_FILENAME > ${MAT_OUTPUTNAME_ROOT}${c}.txt; mv ${MAT_FILENAME}.m ${dataoutput_path}/; mv ${MAT_OUTPUTNAME_ROOT}${c}.txt ${dataoutput_path}/; mv wrkspc_${c}.mat ${dataoutput_path}/
