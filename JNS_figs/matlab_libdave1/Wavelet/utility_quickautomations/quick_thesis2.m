...
if (include_error)
    ...
    errorbar ([0.85, 1.15; 1.85, 2.15], bar_set,errorbar_set,'ko');
else
    errorbar ([0.85, 1.15; 1.85, 2.15], bar_set, [icsyngap_sterr; 0; ic_unblk_sterr;0;0;0;0;0;0] ,'ko');
end

% createsubplot_old(h,bar_set,[0.85, 1.15; 1.85, 2.15],bar_set,errorbar_set);

xlabel_arr = {'onlyion', 'ion+syn'};
