...
function s = stats_dave (s, opts_strct)
...
if nargin > 1
    if isfield (opts_strct, 'lowfreq_min'); lowfreq_min = opts_strct.lowfreq_min; end
    if isfield (opts_strct, 'lowfreq_max'); lowfreq_max = opts_strct.lowfreq_max; end
    if isfield (opts_strct, 'midfreq_min'); midfreq_min = opts_strct.midfreq_min; end
    if isfield (opts_strct, 'midfreq_max'); midfreq_max = opts_strct.midfreq_max; end
    if isfield (opts_strct, 'highfreq_min'); highfreq_min = opts_strct.highfreq_min; end
    if isfield (opts_strct, 'highfreq_max'); highfreq_max = opts_strct.highfreq_max; end
    
    if isfield (opts_strct, 'jlowfreq_min'); jlowfreq_min = opts_strct.jlowfreq_min; end
    if isfield (opts_strct, 'jlowfreq_max'); jlowfreq_max = opts_strct.jlowfreq_max; end
    if isfield (opts_strct, 'jmidfreq_min'); jmidfreq_min = opts_strct.jmidfreq_min; end
    if isfield (opts_strct, 'jmidfreq_max'); jmidfreq_max = opts_strct.jmidfreq_max; end
    
    if isfield (opts_strct, 'FFT_bin_size'); FFT_bin_size = opts_strct.FFT_bin_size; end
    if isfield (opts_strct, 'stats_bin_duration'); stats_bin_duration = opts_strct.stats_bin_duration; end
end
