...
eval (['bar_set = [fb1s_nml_stoch' sf_temp ', '...
                ' fb1s_nml_det' sf_temp '; '...
                ' fb6s_stoch_ap11_5' sf_temp ', '...
                ' fb6s_det_ap11_5' sf_temp '; '...
                ' fb7sonly_stoch_ap11_5' sf_temp ', '...
                ' fb7sonly_det_ap11_5' sf_temp '; '...
                ' fb6s_stoch_bas1_2' sf_temp ', '...
                ' fb6s_det_bas1_2' sf_temp '; '...
                ' fb7sonly_stoch_bas1_2' sf_temp ', '...
                ' fb7sonly_det_bas1_2' sf_temp '];'])
...
if (include_error)
    ...
    sf_temp = stats_suffix;
    sf_temp = [sf_temp 'err'];
    eval (['errorbar_set = [fb1s_nml_stoch' sf_temp ', '...
                ' fb1s_nml_det' sf_temp '; '...
                ' fb6s_stoch_ap11_5' sf_temp ', '...
                ' fb6s_det_ap11_5' sf_temp '; '...
                ' fb7sonly_stoch_ap11_5' sf_temp ', '...
...
xlabel_arr = {'soma nml', 'ap', 'ap det ion', 'bas', 'bas det ion'};
